...
<div class="container">
                    ...
                    <div id="mc_embed_signup">
                       	<form method="GET" action='<?php echo $_SERVER['PHP_SELF'];?>'>
                            ...
                            <div class="input-group">
					            ...
					            <button type="submit" id="cari" class="btn btn-primary">&nbsp;<i class="small fa fa-search"></i>&nbsp;</button></span>
                            </div>
                        </form>
                    <div><br></div>
                    </div>
	...
	<?
	 ...
	 // include_once('smith.php');

	 // $smith = new Smith( echo $data["nama"];, '$_GET["nama"]');
	 // $smith->Search();
